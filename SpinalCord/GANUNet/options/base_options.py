...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default="/home/jjchu/DataSet/spinalcord/", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--batch_size', type=int, default=8, help='input batch size')
        parser.add_argument('--display_winsize', type=int, default=256, help='display window size for both visdom and HTML')
        parser.add_argument('--G_input_nc', type=int, default=1, help='# of input image channels')
        parser.add_argument('--D_input_nc', type=int, default=3, help='# of input image channels')
        parser.add_argument('--DAFF_input_nc', type=int, default=8, help='# of input image channels')
        ...
        parser.add_argument('--affdenoising', type=int, default=0, help='affdenoising')
        parser.add_argument('--n_class', type=int, default=3, help='segmentation classes num')
        parser.add_argument('--direction', type=str, default='AtoB', help='AtoB or BtoA')
        parser.add_argument('--epoch', type=str, default='latest', help='latest which epoch to load? set to latest to use latest cached model')
        # parser.add_argument('--epoch', type=str, default='200', help='latest which epoch to load? set to latest to use latest cached model')
        parser.add_argument('--load_iter', type=int, default='0', help='which iteration to load? if load_iter > 0, the code will load models by iter_[load_iter]; otherwise, the code will load models by [epoch]')
        parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading data') 
        parser.add_argument('--checkpoints_dir', type=str, default="/home/jjchu/Result/GANUNetcheckpoints/", help='models are saved here')
