...
"""
segcgan_80_64_anni_dataset.py
image --> anisodiff --> calculate relation map --> choose  threshold --> GAN --> fake image|anisodiff
(1) contrast: anisodiff image train
(2) contrast: L1(fake image|anisodiff)
(3) 
MSE(fake image|anisodiff)
MSE(fake image - cn)
