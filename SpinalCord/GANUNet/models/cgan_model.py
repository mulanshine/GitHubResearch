...
class CGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_L1','G_PER', 'D_real', 'D_fake'] # 'G_AFF',
    ...
    def backward_D(self):
        ...
        # fake = self.fake_AB_pool.query(torch.cat((self.real_A, self.fake_B), 1))
        fake = self.fake
    ...
    def backward_G(self):
        ...
        self.loss_G_PER = self.criterionPER3(self.fake, self.real) * self.opt.lambda_PER

        # self.loss_G_PER = 0

        # self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_G_AFF + self.loss_G_PER
        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_G_PER
