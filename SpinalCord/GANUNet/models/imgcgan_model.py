...
class ImgCGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['G','G_GAN', 'G_L1', 'G_PER','D','D_target', 'D_fake'] # 'G_AFF','G_PER',
    ...
    def backward_G(self):
        ...
        self.loss_G_PER = self.criterionPER(self.fake, self.target) * self.opt.lambda_PER
