...
from data.spinal_cord_crop_dataset import spinalcordGenlblresize2pad2NormdataSet,spinalcordAnisodiffDataSet, spinalcordNoAnisodiffDataSet, spinalcordCenterCropDataSet,spinalcordGenlblresize2padataSet,spinalcordGen200DataSet
...
def test_net_dice(args, net,batch_size=1,gpu=False,k=0.9):
    ...
    # train_dataset = spinalcordAnisodiffDataSet(args.spinal_root,img_size=args.img_size,site=args.site,batchsize=1, n_class=args.n_class, nlabel=args.nlabel,set=args.set)
    train_dataset = spinalcordGenlblresize2pad2NormdataSet(args.spinal_root,img_size=args.img_size,site=args.site,batchsize=1, n_class=args.n_class, nlabel=args.nlabel,set=args.set)
...
def get_args():
    ...
    parser.add_option("--spinal_root", default="/share/jjchu/SpinalCord/CGANResults/segcgan_imgdenoise_norm2site12_site12_80_64_10L1_10PER_10SEG_resnet_5blocks_batch8_step300_relation/test_latest/images/", type=str)
    parser.add_option("--savepath", default="/share/jjchu/SpinalCord/UNetResults/softmultiDiceLoss/real_site12_noanisodiff311_80_64_batch4_step400_b12_25l_1103/",type=str)
    parser.add_option('-c', '--load', default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/segcgan_imgdenoise_norm2site12_site12_80_64_10L1_10PER_10SEG_resnet_5blocks_batch8_step300_relation_fake_b12_25l_1103/CP50.pth",help='load file model')
...
if __name__ == '__main__':
    args = get_args()
    print("spinalcordAnisodiffDataSet")
