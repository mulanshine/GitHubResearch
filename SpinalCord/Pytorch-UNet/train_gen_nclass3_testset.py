...
def test_net_dice(args, net, batch_size=1, gpu=False,site=["site3","site3"]):
    ...
    # train_dataset = spinalcordGenlblresize2pad2NormdataSet(args.spinal_root,img_size=args.img_size,site=site,batchsize=1, n_class=args.n_class, nlabel=args.nlabel,set=args.set,strends='fake')
...
def train_net(args, net,epochs=5,batch_size=1,lr=0.1,val_percent=0.05,save_cp=True,gpu=False):
    ...
    for epoch in range(epochs):
        ...
        # train_dataset = spinalcordGenlblresize2pad2NormdataSet(args.spinal_root, img_size=args.img_size,site=args.site,batchsize=args.batchsize, n_class=args.n_class, nlabel=args.nlabel,set=args.set,strends=args.real_or_fake)
        # gen 200*200 fake
...
def get_args():
    ...
    parser.add_option("--logfile", default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/segcgan_200_200_10L1_10PER_10SEG_resnet_5blocks_batch4_step400_relation_pad_meanstd_ddetach_maxminnorm_img_fake_b4_25l_1103/log.txt",type=str)
    parser.add_option("--snapshots", default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/segcgan_200_200_10L1_10PER_10SEG_resnet_5blocks_batch4_step400_relation_pad_meanstd_ddetach_maxminnorm_img_fake_b4_25l_1103/",type=str)
    parser.add_option("--savepath", default="/share/jjchu/SpinalCord/UNetResults/softmultiDiceLoss/test2/",type=str)  

    # parser.add_option("--spinal_root", default="/share/jjchu/SpinalCord/spinalcord/", type=str)
    # parser.add_option("--logfile", default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/real_denoise_norm2site12_80_64_b12_25l_1103/log.txt",type=str)
    # parser.add_option("--snapshots", default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/real_denoise_norm2site12_80_64_b12_25l_1103/",type=str)
    # parser.add_option("--savepath", default="/share/jjchu/SpinalCord/UNetResults/softmultiDiceLoss/real_denoise_norm2site12_80_64_b12_25l_1103/",type=str)    
