...
from data.spinal_cord_crop_dataset import spinalcordGenlblresize2pad2NormSite3dataSet,spinalcordCropDataSet, spinalcordGenlblresize2pad2NormdataSet, spinalcordGenlblresize2padataSet, spinalcordCenterCropDataSet, spinalcordGen200DataSet,spinalcordAnisodiffDataSet #,spinalcordGenlblresize2padatatestSet
import scipy
...
def test_net_dice(args, net, batch_size=1, gpu=False,site=["site4","site4"]):
    ...
    train_dataset = spinalcordGenlblresize2pad2NormSite3dataSet(args.spinal_root,img_size=args.img_size,site=site,batchsize=1, n_class=args.n_class, nlabel=args.nlabel,set=args.set,strends='real')
    # train_dataset = spinalcordGenlblresize2padataSet(args.spinal_root,img_size=args.img_size,site=site,batchsize=1, n_class=args.n_class, nlabel=args.nlabel,set=args.set,strends=args.real_or_fake)
    # centercrop 200*200
    ...
    # gen 200*200 fake
    # train_dataset = spinalcordGen200DataSet(args.spinal_root,img_size=args.img_size,site=site,batchsize=1, n_class=args.n_class, nlabel=args.nlabel, set=args.set,strends=args.real_or_fake)
...
def train_net(args, net,epochs=5,batch_size=1,lr=0.1,val_percent=0.05,save_cp=True,gpu=False):
    ...
    for epoch in range(epochs):
        ...
        train_dataset = spinalcordGenlblresize2pad2NormSite3dataSet(args.spinal_root, img_size=args.img_size,site=args.site,batchsize=args.batchsize, n_class=args.n_class, nlabel=args.nlabel,set=args.set,strends=args.real_or_fake)
        # gen 200*200 fake
...
def get_args():
    ...
    parser.add_option("--logfile", default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/trainsite3_pixgan_nodenoise_site12_norm2_80_64_10L1_10PER12_1GANIMG_resnet_5blocks_batch8_step100_relation_real_b12_25l_1103/log.txt",type=str)
    parser.add_option("--snapshots", default="/share/jjchu/SpinalCord/UNetsnapshots/softmultiDiceLoss/trainsite3_pixgan_nodenoise_site12_norm2_80_64_10L1_10PER12_1GANIMG_resnet_5blocks_batch8_step100_relation_real_b12_25l_1103/",type=str)
    parser.add_option("--savepath", default="/share/jjchu/SpinalCord/UNetResults/softmultiDiceLoss/trainsite3_pixgan_nodenoise_site12_norm2_80_64_10L1_10PER12_1GANIMG_resnet_5blocks_batch8_step100_relation_real_b12_25l_1103/",type=str)    
