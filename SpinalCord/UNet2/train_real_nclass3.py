...
def get_args():
    ...
    # parser.add_option('-c', '--load', default="/home/jjchu/Result/UNetsnapshots/Real_dropout_TranUNet5_kernel7_center100_site12_meanstd_imgs_b8_25l_1103/CP60.pth",help='load file model')
